...
3. **Set Messaging Endpoint**:
   - Click **Configuration**
   - Set endpoint to: `https://alphatechx.fly.dev/api/teams/messages`
   - Click **Apply**
...
| Bot Service | https://alphatechx.fly.dev | Running on Fly.io |
| Web UI | https://alphatechx.fly.dev | Users upload documents here |
